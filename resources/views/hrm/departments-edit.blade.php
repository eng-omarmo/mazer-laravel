    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Update department details and head assignment</p>
            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="head_employee_id" class="form-select">
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->id }}" {{ old('head_employee_id', $department->head_employee_id) == $emp->id ? 'selected' : '' }}>{{ $emp->first_name }} {{ $emp->last_name }} ({{ $emp->email }})</option>
                                @endforeach
                            </select>
